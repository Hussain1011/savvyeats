frappe.listview_settings["Delivery Note"] = {
	...
	onload: function (doclist) {
		...
		doclist.page.add_inner_button(__('Create Today Deliveries'), function() {
            frappe.call({
            	method: "savvyeats.custom.delivery_note_savvy_eats.create_today_deliveries",
            	freeze: true,
            	freeze_message: __("Creating Deliveries"),
            	callback: function(r){
            		console.log(doclist);
            	}
            })
